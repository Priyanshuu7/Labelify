...
export const Upload = () => {
    ...
    return <div className="flex justify-center">
        <div className="max-w-screen-lg w-full">
            ...
            <div className="flex flex-wrap justify-center gap-4 pt-4 max-w-screen-lg">
  {images.map(image => (
    <img key={image} src={image} className="w-40 h-40 rounded object-cover" alt="Uploaded preview" />
  ))}
</div>

<div className="ml-4 pt-4 flex justify-center">
