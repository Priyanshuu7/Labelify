    ...
    .object({
        options: zod_1
            ...
            .array(zod_1.default.object({
                imageUrl: zod_1
                    .default
                    .string(), // Each option must have an imageUrl of type string
            })),
        title: zod_1
            .default
            .string()
        ...
        signature: zod_1
            .default
            .string(), // Signature is a required string
    });
// Define the schema for creating a submission input
exports.createSubmissionInput = zod_1
    .default
    .object({
        taskId: zod_1
            .default
            .string(), // Task ID is a required string
        selection: zod_1
            .default
            .string(), // Selection is a required string
    });
